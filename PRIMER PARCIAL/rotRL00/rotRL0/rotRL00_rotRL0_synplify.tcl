...
add_file -vhdl -lib "work" {C:/lscc/diamond/3.11_x64/bin/nt64/Arqui/Practicas/rotRL00/rotRL00.vhdl}
add_file -vhdl -lib "work" {C:/lscc/diamond/3.11_x64/bin/nt64/Arqui/Practicas/rotRL00/packagerotRL00.vhdl}
add_file -vhdl -lib "work" {C:/lscc/diamond/3.11_x64/bin/nt64/Arqui/Practicas/rotRL00/toprotRL00.vhdl}

#-- top module name
set_option -top_module toprotRL00

#-- set result format/file last
project -result_file {C:/lscc/diamond/3.11_x64/bin/nt64/Arqui/Practicas/rotRL00/rotRL0/rotRL00_rotRL0.edi}

#-- error message log file
project -log_file {rotRL00_rotRL0.srf}
