...
add_file -vhdl -lib "work" {C:/lscc/diamond/3.11_x64/bin/nt64/Arqui/Practicas/rotLR00/rotLR00.vhdl}
add_file -vhdl -lib "work" {C:/lscc/diamond/3.11_x64/bin/nt64/Arqui/Practicas/rotLR00/packagerotLR00.vhdl}
add_file -vhdl -lib "work" {C:/lscc/diamond/3.11_x64/bin/nt64/Arqui/Practicas/rotLR00/toprotLR00.vhdl}

#-- top module name
set_option -top_module toprotLR00

#-- set result format/file last
project -result_file {C:/lscc/diamond/3.11_x64/bin/nt64/Arqui/Practicas/rotLR00/rotLR0/rotLR00_rotLR0.edi}

#-- error message log file
project -log_file {rotLR00_rotLR0.srf}
